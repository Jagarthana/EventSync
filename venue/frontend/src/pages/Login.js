...
/**
 * Venue departmental portal: official sign-in only.
 */
export function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (roles.includes('Venue') || roles.includes('Admin')) {
        navigate('/dashboard-venue');
      } else {
        setError('This portal is for Venue officers. Use the Governance or Finance portal that matches your role.');
      }
    } catch (err) {
